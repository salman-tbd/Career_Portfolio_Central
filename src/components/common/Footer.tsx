        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-1 lg:col-span-1">
            <Link href="/" className="inline-block mb-6 group">
              <div className="relative w-48 h-20 lg:w-56 lg:h-18">
                <Image
                  src="/assets/logo/Career Portfolio Central Logo_-04.png"
            ...
            <div className="flex space-x-4">
              <a
                href="https://x.com/central787271"
                target="_blank"
              ...
              <a
                href="https://www.facebook.com/profile.php?id=61582256633705"
                target="_blank"
                rel="noopener noreferrer"
                className="text-brand-gray-400 hover:text-white transition-colors duration-200"
                aria-label="Facebook"
              ...
              <a
                href="https://www.instagram.com/careerportfoliocentral/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-brand-gray-400 hover:text-white transition-colors duration-200"
        ...
        <div className="mt-12 pt-8 border-t border-brand-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              <Link
                href="/privacy"
                className="text-brand-gray-400 hover:text-white text-sm transition-colors duration-200"
              >
                Privacy Policy
              </Link>
              <Link
